...
#### 메인화면
![메인](README.assets/mainpage.png)

#### 마이페이지화면
![마이](README.assets/mypage.png)

#### 이력서 작성화면
![이력서](README.assets/intropage.png)

#### 포트폴리오 프로젝트 등록화면
![등록](README.assets/projectinsertpage.png)

#### 프로젝트 편집화면
![편집](README.assets/projecteditpage.png)

#### 템플릿 선택화면
![템플릿](README.assets/templateselectionpage.png)

#### 만들어진 포트폴리오화면
![완성](README.assets/templaterespage.png)

## :building_construction: 아키텍쳐
![아키](README.assets/architecture.png)

## :hammer_and_wrench: 기술스택
![기술](README.assets/techstack.png)
...
| 제작 페이지                             | 제작 페이지 입장 시 자동으로 크롤링 진행<br />1단계 프로젝트 디자인 선택 ⇒ 프로젝트 대표 이미지 넣으면 분석을 통하여 가장 지배적인 색상 두가지를 추출, 그라데이션으로 배경 적용. 커스터마이징 가능. <br />2단계 (프로젝트 상세) 배치에 대해 사용자가 커스타마이징 가능하도록<br /> 개인소개 + 기술스택 + 프로젝트소개 | 유저 entity에 추가해야할 것: 디자인, 이미지 배치 위치 등으로 유저가 선택한 항목 각각을 저장하는 field 필요.<br />⇒ 개인정보에 관한 내용 컨설팅 요청|           |
